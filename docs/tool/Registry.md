...
The service can be configured using environment variables. See [.env.example](https://github.com/modelcontextprotocol/registry/tree/main/.env.example) for details.
...
See the [LICENSE](https://github.com/modelcontextprotocol/registry/tree/main/LICENSE) file for details.
