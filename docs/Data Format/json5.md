...
It's also a *subset* of ES5, so valid JSON5 files will always be valid ES5.[\*](#ecmascript-compatibility)
...
described in our [security policy](https://github.com/json5/json5/tree/main/SECURITY.md).
...
MIT. See [LICENSE.md](https://github.com/json5/json5/tree/main/LICENSE.md) for details.
...
[json\_parse.js][json_parse.js] parser. We’re grateful for that clean and well-documented
code.
